...
public class Update_FinanceManager_PO {
	...
	WebDriver driver;
    {
       ...
       @FindBy(how= How.XPATH, using="(//a[@title='Edit finance manager !'])[1] ")
       WebElement Update_FinanceManager;
       ...
       public void Update_FinanceManager()
       {
    	   Update_FinanceManager.click();
       	ExtentReport.test.log(LogStatus.INFO, "Clicked on Update Finance Manager Button", "Clicked");
       }
      public void Name(String args)
      {
    	  Name.clear();
   	      Name.sendKeys(args);
   	   ExtentReport.test.log(LogStatus.INFO, "Enter the Finance manager Name as ", args);
      }
      ...
      public void Update_Finance_Manager(String loginEmail, String loginPassword,String Name,String Mobile,String Email,String Address) throws InterruptedException
      {
