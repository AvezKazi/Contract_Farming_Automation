...
public class Update_Category_PO {
...
@FindBy(how= How.XPATH, using="(//a[@title='Ticket Update !'] )[1]")
WebElement Update_Category;
...
public void Update_Category()
{
	Update_Category.click();
	 ExtentReport.test.log(LogStatus.INFO, "Clicked on the Update Category Button", "Clicked");
}
...
public void Update_with_ValidData(String loginEmail, String loginPassword,String Category_Name) throws InterruptedException
{
