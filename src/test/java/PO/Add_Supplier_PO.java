...
{
	 Add_Supplier.click();
	ExtentReport.test.log(LogStatus.INFO, "Cliked on Add Supplier", "Cliked");
}
...
public void Add_Supplier_with_all_ValidData(String loginEmail, String loginPassword,String Name,String Mobile,String Email,String Address,String GST_Number) throws InterruptedException
{
 try {
