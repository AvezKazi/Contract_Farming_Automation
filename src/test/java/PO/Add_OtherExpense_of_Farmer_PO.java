...
public class Add_OtherExpense_of_Farmer_PO {
...
{
	Add_Expenses.click();
	 ExtentReport.test.log(LogStatus.INFO, "Clicked on the Add Expense", "Clicked");
}
...
public void Add_Farmers_OtherExpense_with_ValidData(String loginEmail, String loginPassword,String Date,String Select_Category,String Expense_Name,String Quantity,String Total_Amount,String Remark,String Bill_Image,String Verification_Status) throws InterruptedException
{
