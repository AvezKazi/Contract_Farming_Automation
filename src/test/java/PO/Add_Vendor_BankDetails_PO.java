...
public class Add_Vendor_BankDetails_PO {
	 WebDriver driver;
     {
       	this.driver = driver;
      }
...
public void Add_Vendors_BankDetails_with_ValidData(String loginEmail, String loginPassword,String Account_Holder_Name,String Account_Number,String Re_Enter_AccountNUmber,String Bank_Name,String Bank_Branch,String Branch_Address,String IFSC_Code,String Cheque_Image) throws InterruptedException
{
