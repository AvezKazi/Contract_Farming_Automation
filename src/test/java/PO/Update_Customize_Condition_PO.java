...
public class Update_Customize_Condition_PO {
   ...
   @FindBy(how= How.XPATH, using="(//a[@title='Edit condition !'] )[1]")
   WebElement Update_Customize_Condition;
   ...
   public void EnterPassword (String args)
      ...
      public void Update_Customize_Condition()
      {
    	  Update_Customize_Condition.click();
      	ExtentReport.test.log(LogStatus.INFO, "Clicked on Update Customize Condition Button", "Clicked");
      }
      public void Select_Contract_Category(String args)
      {
    	  Select_Contract_Category.clear();
   ...
   public void Update_Customize_Condition_with_ValidData(String txt_AdminEmail,String EnterPassword,String Select_Contract_Category,String Enter_Points,String Image) throws InterruptedException
   {
