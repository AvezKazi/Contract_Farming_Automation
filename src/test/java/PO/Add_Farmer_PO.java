...
public class Add_Farmer_PO {
	...
	WebDriver driver;
    {
       ...
       @FindBy(how= How.XPATH, using="(//a[@class='btn btn-outline-danger btn-flat btn-sm float-right'])[1]")
       WebElement Add_Farmer;
       ...
       {
    	   Add_Farmer.click();
       	ExtentReport.test.log(LogStatus.INFO, "Clicked on Add Farmer Button", "Clicked");
       }
      ...
      public void Add_Farmer_with_ValidData(String loginEmail, String loginPassword,String Select_Type,String Profile_Image,String Name,String Mobile,String Email,String Description,String PanCard,String PanCard_Image,String Aadhar_Number,String Aadhar_Image,String GST_NO,String StreetName,String Pincode,String State,String District,String Block,String Village,String Address,String Password,String Status) throws InterruptedException
      {
