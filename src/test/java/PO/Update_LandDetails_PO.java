...
public class Update_LandDetails_PO {
	...
	WebDriver driver;
    {
       ...
       @FindBy(how= How.XPATH, using="//a[@title='Edit Land Details !']")
       WebElement Update_Land;
       ...
       @FindBy(how= How.XPATH, using="//button[@onclick=' edit(70)']")
       WebElement Edit;
       ...
       {
    	   Update_Land.click();
    	  ExtentReport.test.log(LogStatus.INFO, "Click on Update land", "Clicked");
       }
      ...
      {
   	   Edit.click(); 
   	   ExtentReport.test.log(LogStatus.INFO, "Cliked on Edit Button", "Clicked");
      }
      public void Yes()
      {
   	   Click_YES.click(); 
