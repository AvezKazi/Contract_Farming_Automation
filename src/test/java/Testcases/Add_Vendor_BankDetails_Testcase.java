...
import PO.Add_Vendor_BankDetails_PO;
import Utility.BrowserManager;

public class Add_Vendor_BankDetails_Testcase {
	WebDriver driver;
    ...
    public void loca ( ) throws Throwable {
  	  ...
  	  try {
  		  String FileName= "data/Vendor_BankDetails.json";
    ...
    @Test
    public void Add_Vendor_BankDetails_with_all_the_valid_data () throws Throwable {
      ...
      ExtentReport.test=ExtentReport.extent.startTest("Add_Vendor_BankDetails_with_all_the_valid_data");
      Add_Vendor_BankDetails_PO Obj = PageFactory.initElements(driver, Add_Vendor_BankDetails_PO.class);
  	  Obj.Add_Vendors_BankDetails_with_ValidData(loginEmail, loginPassword, Account_Holder_Name, Account_Number, Re_Enter_AccountNUmber, Bank_Name, Bank_Branch, Branch_Address, IFSC_Code, Cheque_Image);
