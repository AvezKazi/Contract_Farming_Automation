...
import PO.Add_OtherExpense_of_Farmer_PO;
import Utility.BrowserManager;

public class Add_Farmer_OtherExpense_Testcase {
    ...
    public void loca ( ) throws Throwable {
  	  ...
  	  try {
  		  String FileName= "data/Farmer_OtherExpense.json";
    ...
    @Test
    public void Add_Farmer_Other_Expenses_with_all_the_valid_data () throws Throwable {
      ...
      Add_OtherExpense_of_Farmer_PO Obj = PageFactory.initElements(driver, Add_OtherExpense_of_Farmer_PO.class);
  	  Obj.Add_Farmers_OtherExpense_with_ValidData(loginEmail, loginPassword, Date, Select_Category, Expense_Name, Quantity, Total_Amount, Remark, Bill_Image, Verification_Status);
